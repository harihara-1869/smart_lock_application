...
class _Capdu extends Capdu {
  const _Capdu({required this.cla, required this.ins, required this.p1, required this.p2, required this.data}): super._();
...
mixin _$Rapdu {
 ...
 Uint8List get data; int get sw1; int get sw2;
/// Create a copy of Rapdu
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$RapduCopyWith<Rapdu> get copyWith => _$RapduCopyWithImpl<Rapdu>(this as Rapdu, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Rapdu&&const DeepCollectionEquality().equals(other.data, data)&&(identical(other.sw1, sw1) || other.sw1 == sw1)&&(identical(other.sw2, sw2) || other.sw2 == sw2));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(data),sw1,sw2);
...
/// @nodoc
abstract mixin class $RapduCopyWith<$Res>  {
  factory $RapduCopyWith(Rapdu value, $Res Function(Rapdu) _then) = _$RapduCopyWithImpl;
@useResult
$Res call({
 Uint8List data, int sw1, int sw2
});
...
/// @nodoc
class _$RapduCopyWithImpl<$Res>
    implements $RapduCopyWith<$Res> {
  _$RapduCopyWithImpl(this._self, this._then);

  final Rapdu _self;
  final $Res Function(Rapdu) _then;

/// Create a copy of Rapdu
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? data = null,Object? sw1 = null,Object? sw2 = null,}) {
  return _then(Rapdu(
data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as Uint8List,sw1: null == sw1 ? _self.sw1 : sw1 // ignore: cast_nullable_to_non_nullable
as int,sw2: null == sw2 ? _self.sw2 : sw2 // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
/// Adds pattern-matching-related methods to [Rapdu].
extension RapduPatterns on Rapdu {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Rapdu value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Rapdu() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Rapdu value)  $default,){
final _that = this;
switch (_that) {
case _Rapdu():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Rapdu value)?  $default,){
final _that = this;
switch (_that) {
case _Rapdu() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Uint8List data,  int sw1,  int sw2)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Rapdu() when $default != null:
return $default(_that.data,_that.sw1,_that.sw2);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Uint8List data,  int sw1,  int sw2)  $default,) {final _that = this;
switch (_that) {
case _Rapdu():
return $default(_that.data,_that.sw1,_that.sw2);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Uint8List data,  int sw1,  int sw2)?  $default,) {final _that = this;
switch (_that) {
case _Rapdu() when $default != null:
return $default(_that.data,_that.sw1,_that.sw2);case _:
  return null;
...
class _Rapdu extends Rapdu {
  const _Rapdu({required this.data, required this.sw1, required this.sw2}): super._();
  

@override final  Uint8List data;
@override final  int sw1;
@override final  int sw2;

/// Create a copy of Rapdu
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$RapduCopyWith<_Rapdu> get copyWith => __$RapduCopyWithImpl<_Rapdu>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Rapdu&&const DeepCollectionEquality().equals(other.data, data)&&(identical(other.sw1, sw1) || other.sw1 == sw1)&&(identical(other.sw2, sw2) || other.sw2 == sw2));
}
...
/// @nodoc
abstract mixin class _$RapduCopyWith<$Res> implements $RapduCopyWith<$Res> {
  factory _$RapduCopyWith(_Rapdu value, $Res Function(_Rapdu) _then) = __$RapduCopyWithImpl;
@override @useResult
$Res call({
 Uint8List data, int sw1, int sw2
});
...
/// @nodoc
class __$RapduCopyWithImpl<$Res>
    implements _$RapduCopyWith<$Res> {
  __$RapduCopyWithImpl(this._self, this._then);

  final _Rapdu _self;
  final $Res Function(_Rapdu) _then;

/// Create a copy of Rapdu
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? data = null,Object? sw1 = null,Object? sw2 = null,}) {
  return _then(_Rapdu(
data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as Uint8List,sw1: null == sw1 ? _self.sw1 : sw1 // ignore: cast_nullable_to_non_nullable
as int,sw2: null == sw2 ? _self.sw2 : sw2 // ignore: cast_nullable_to_non_nullable
